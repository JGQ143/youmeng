package com.example.jiaguoqiang20190120.di.beans;
...
public class GoodBean {
    ...
    public static class DataBean {
        ...
        private boolean onGoodChecked;

        public boolean getOnGoodChecked() {
            return onGoodChecked;
        }

        public void setOnGoodChecked(boolean onGoodChecked) {
            this.onGoodChecked = onGoodChecked;
        }
        ...
        public static class ListBean {
            ...
            public boolean isOnGoodsChecked() {
